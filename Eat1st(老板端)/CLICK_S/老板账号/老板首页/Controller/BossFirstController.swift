...
class BossFirstController: LBBaseViewController {
...
//        //标题栏的背景色
    ...
    private let switchBut: UIButton = {
        let but = UIButton()
        but.setImage(LOIMG("nav_qh"), for: .normal)
        but.isHidden = false
        return but
    }()
    ...
    override func setViews() {
        ...
        switchBut.addTarget(self, action: #selector(clickMsgAction), for: .touchUpInside)
