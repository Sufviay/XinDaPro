...
class StoreTimeSettingController: LBBaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let line: UIImageView = {
        ...
        img.image = GRADIENTCOLOR(HCOLOR("#28B1FF"), HCOLOR("#2B8AFF"), CGSize(width: 70, height: 3), 0)
        return img
    }()
