...
class PromotionListController: LBBaseViewController, UITableViewDelegate, UITableViewDataSource, SystemAlertProtocol {
    ...
    override func setNavi() {
        ...
        self.biaoTiLab.text = "Coupon Management".local
        loadData_Net()
    }
