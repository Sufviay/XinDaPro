...
class DetailMoneyCell: BaseTableViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    private let titStrArr: [String] = ["Food and drink total", "Delivery fee", "Service charge", "Bag fee", "Dishes discount", "Coupon", "Discount", "", "Total", "Wallet", "Payment"]
...
class MoneyCell: BaseTableViewCell {
    ...
    private let moneyLab: UILabel = {
        let lab = UILabel()
        lab.setCommentStyle(TXTCOLOR_1, BFONT(15), .right)
        lab.text = "£10"
        return lab
    }()
    ...
    private let titLab: UILabel = {
        let lab = UILabel()
        lab.setCommentStyle(TXTCOLOR_1, SFONT(14), .left)
