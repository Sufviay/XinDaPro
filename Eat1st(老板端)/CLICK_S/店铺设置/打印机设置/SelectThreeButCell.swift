...
class SelectThreeButCell: BaseTableViewCell {
    ...
    func setCellData(titStr: String, str1: String, str2: String, str3: String, selectType: String) {
        titlab.text = titStr
        oneLab.text = str1
        twoLab.text = str2
        threeLab.text = str3
