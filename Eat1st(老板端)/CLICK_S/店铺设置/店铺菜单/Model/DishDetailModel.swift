...
class DishDetailComboModel: HandyJSON {
    ...
    func updateModel() {
        ...
        let h1 = name1.getTextHeigh(TIT_16, S_W - 120)
        let h2 = name2.getTextHeigh(TXT_14, S_W - 120)
...
class ComboDishModel: HandyJSON {
    ...
    func updateModel() {
        ...
        let h1 = name1.getTextHeigh(TIT_14, S_W - 95)
        let h2 = name2.getTextHeigh(TXT_14, S_W - 95)
...
class DishDetailSpecModel: HandyJSON {
    ...
    func updateModel() {
        ...
        let h1 = name1.getTextHeigh(TIT_14, S_W - 120)
        let h2 = name2.getTextHeigh(TXT_14, S_W - 120)
