...
class SelectFiveButCell: BaseTableViewCell {
    ...
    override func setViews() {
        ...
        twoBut.snp.makeConstraints {
            $0.left.equalTo(oneBut.snp.right)
            $0.size.top.equalTo(oneBut)
        }
        
        contentView.addSubview(threeBut)
        threeBut.snp.makeConstraints {
            $0.top.size.equalTo(oneBut)
        ...
        contentView.addSubview(fiveBut)
        fiveBut.snp.makeConstraints {
        ...
        fiveBut.addSubview(img5)
        img5.snp.makeConstraints {
            $0.left.equalToSuperview().offset(20)
            $0.centerY.equalToSuperview()
        }
        
        fiveBut.addSubview(fiveLab)
        fiveLab.snp.makeConstraints {
            $0.centerY.equalToSuperview()
            $0.left.equalToSuperview().offset(35)
            $0.right.equalToSuperview()
        }
        ...
        fiveBut.addTarget(self, action: #selector(clickFiveAction), for: .touchUpInside)
    }
    
    
    func setCellData(titStr: String, str1: String, str2: String, str3: String, str4: String, str5: String, selectType: String, ) {
        titlab.text = titStr
        oneLab.text = str1
        twoLab.text = str2
        threeLab.text = str3
...
//    }
    ...
    @objc private func clickFiveAction() {
        if selectIdx != "4" {
            selectIdx = "4"
        } else {
            selectIdx = ""
