...
class LogInController: BaseViewController {
    ...
    private let loginBut: UIButton = {
        let but = UIButton()
        but.setCommentStyle(.zero, "Sign in", .white, BFONT(15), HCOLOR("#007CFF"))
    ...
    private func setUpUI() {
        ...
        textImg.snp.makeConstraints {
            ...
            $0.top.equalTo(R_H(95))
        }
        
        
        backImg.addSubview(tlab1)
        tlab1.snp.makeConstraints {
            $0.left.equalTo(textImg)
            $0.top.equalTo(textImg.snp.bottom).offset(55)
        }
        
        backImg.addSubview(tlab2)
        tlab2.snp.makeConstraints {
            $0.left.equalTo(tlab1)
            $0.top.equalTo(tlab1.snp.bottom).offset(70)
        }
        ...
        line1.snp.makeConstraints {
            $0.left.equalToSuperview().offset(R_W(30))
            $0.right.equalToSuperview().offset(-R_W(30))
            $0.top.equalTo(tlab1.snp.bottom).offset(45)
            $0.height.equalTo(1)
        }
        ...
        line2.snp.makeConstraints {
            ...
            $0.top.equalTo(tlab2.snp.bottom).offset(45)
            $0.height.equalTo(1)
        }
        ...
        loginBut.snp.makeConstraints {
            $0.left.right.equalTo(line1)
            $0.top.equalTo(line2.snp.bottom).offset(45)
            $0.height.equalTo(50)
        }
        ...
        b_biew.snp.makeConstraints {
            ...
            $0.height.equalTo(40)
            $0.top.equalTo(loginBut.snp.bottom).offset(40)
            $0.width.equalTo(280)
        }
    ...
    @objc private func clickLogInAction() {
        ...
        HTTPTOOl.userLogIn(user: emailTF.text!, pw: passwordTF.text!).subscribe(onNext: { (json) in
            ...
            UserDefaults.standard.accountNum = json["data"]["account"].stringValue
