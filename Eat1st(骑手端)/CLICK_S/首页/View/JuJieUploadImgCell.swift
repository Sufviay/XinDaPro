...
class JuJieUploadImgCell: BaseTableViewCell, UICollectionViewDataSource, UICollectionViewDelegate, CommonToolProtocol, HXCustomNavigationControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, SystemAlertProtocol {
