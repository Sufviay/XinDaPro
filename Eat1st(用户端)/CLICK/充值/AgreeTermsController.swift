...
class AgreeTermsController: BaseViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    private let agreeBut: UIButton = {
        let but = UIButton()
        but.setCommentStyle(.zero, "Agree and continue", FONTCOLOR, BFONT(14), MAINCOLOR)
    ...
    override func setViews() {
        ...
        view.addSubview(agreeBut)
        agreeBut.snp.makeConstraints {
        ...
        configWeb()
        agreeBut.addTarget(self, action: #selector(clickAgreeAction), for: .touchUpInside)
    }
    ...
    @objc private func clickAgreeAction() {
        UserDefaults.standard.isAgree = true
...
//        userContent.add(self as! WKScriptMessageHandler, name: "webViewApp")
        ...
        webView?.snp.makeConstraints {
            ...
            $0.bottom.equalTo(agreeBut.safeAreaLayoutGuide.snp.top).offset(-10)
        }
