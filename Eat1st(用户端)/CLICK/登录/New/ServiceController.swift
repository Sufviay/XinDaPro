...
class ServiceController: BaseViewController, WKUIDelegate, WKNavigationDelegate  {
...
//        webView.evaluateJavaScript("ocument.getElementsByTagName('body')[0].style.webkitTextSizeAdjust= '500%'", completionHandler: nil)
//    }
