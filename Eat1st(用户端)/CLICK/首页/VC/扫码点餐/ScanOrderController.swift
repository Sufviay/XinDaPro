//
//  ScanOrderController.swift
//  CLICK
//
//  Created by 肖扬 on 2023/6/12.
//
...
//class ScanOrderController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
//
...
//        
//        tableView.register(ScanOrderStoreContentCell.self, forCellReuseIdentifier: "ScanOrderStoreContentCell")
...
//            return storeInfo.scanContent_H
//        }
...
//        if indexPath.section == 0 {
//            
//            let cell = tableView.dequeueReusableCell(withIdentifier: "ScanOrderStoreContentCell") as! ScanOrderStoreContentCell
...
//            cell.setCellData(model: menuInfo, deskID: deskID)
//            
//            //弹出购物车
...
//                        
//            ///更新底部购物车栏
//            self.b_view.setValue(dishMoney: D_2_STR(cartModel.allPrice), buyCount: cartModel.dishesNum, discountType: cartModel.discountType, discountMoney: D_2_STR(cartModel.discountAmount), minOrder: D_2_STR(storeInfo.minOrder), type: cartModel.deliveryType)
//
//            self.b_view.isHidden = false
//            self.mainTable.isHidden = false
//            HUD_MB.dissmiss(onView: self.view)
...
//        let h = storeInfo.storeSellLunchOrDinner == "2" ? storeInfo.scanContent_H + 50 : storeInfo.scanContent_H
