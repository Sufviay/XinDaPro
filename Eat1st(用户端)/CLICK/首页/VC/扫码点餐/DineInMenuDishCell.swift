//
//  DineInMenuDishCell.swift
//  CLICK
//
//  Created by 肖扬 on 2024/5/20.
//

import UIKit

//class DineInMenuDishCell: BaseTableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, SDPhotoBrowserDelegate, CommonToolProtocol, UICollectionViewDelegateFlowLayout {
//
//    ///选择规格
...
//
//        
//        contentView.addSubview(name1Lab)
//        name1Lab.snp.makeConstraints {
//            $0.top.equalToSuperview().offset(15)
//            $0.left.equalTo(goodsImg.snp.right).offset(10)
//            $0.right.equalToSuperview().offset(-15)
//        }
//        
//        contentView.addSubview(name2Lab)
//        name2Lab.snp.makeConstraints {
//            $0.left.right.equalTo(name1Lab)
//            $0.top.equalTo(name1Lab.snp.bottom).offset(2)
//        }
//        
//        contentView.addSubview(desLab)
//        desLab.snp.makeConstraints {
//            $0.left.right.equalTo(name1Lab)
//            $0.top.equalTo(name2Lab.snp.bottom).offset(5)
//        }
//        
//        
...
//        //设置是否启用
//        if model.isOn == "1" {
//            self.name1Lab.textColor = FONTCOLOR
//            self.name2Lab.textColor = FONTCOLOR
//            self.s_lab.textColor = HCOLOR("FB5348")
//            self.moneyLab.textColor = HCOLOR("FB5348")
//        } else {
//            self.name1Lab.textColor = HCOLOR("#AAAAAA")
//            self.name2Lab.textColor = HCOLOR("#AAAAAA")
...
//        self.name1Lab.text = model.name_CN
//        self.name2Lab.text = model.name_EN
